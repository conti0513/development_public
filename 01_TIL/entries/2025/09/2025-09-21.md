...
## 📌 本日の取り組み
* **SC-900 学習開始**
  * Microsoft Learn をベースに、セキュリティ基礎を整理  
...
## 🚀 次のアクション
* SC-900 の学習範囲を週ごとに分割し、10月中の合格を目指す  
* TILを日次更新して「取り戻す10月」に備える  
* 実務で触れているゼロトラストや監査対応とリンクさせて理解を強化する
...
## Week 0（準備）
- [ ] Microsoft Learn アカウント登録
- [ ] **Practice Assessment（模擬試験）** を1回実施（弱点確認）
- [ ] 学習ノート/TIL用のMarkdownファイル準備

---

## Week 1：セキュリティ・IDの基礎
- [ ] **共有責任モデル**（Shared Responsibility Model）
- [ ] **セキュリティ・コンプライアンス・IDの基本概念**
- [ ] **ゼロトラストモデル**（Zero Trust）
- [ ] **IAMの基礎**（認証 / 認可 / RBAC）
- [ ] Week1 復習メモ（TILに整理）

---

## Week 2：Microsoft Entra（旧Azure AD）
- [ ] **Entra ID（Azure AD）の概要**
- [ ] **シングルサインオン（SSO）**
- [ ] **多要素認証（MFA）**
...
## Week 3：Microsoft Defender / Purview
...
## Week 4：Microsoft Sentinel / 総仕上げ
- [ ] **Microsoft Sentinel**
  - [ ] SIEMの基礎
  - [ ] SOAR（自動化対応）
- [ ] 模擬試験（80%以上を目標）
