...
## 📌 本日の取り組み
* **SC-900 学習開始**
  - Microsoft Learn をベースにセキュリティ基礎を整理  
  - アイデンティティ、アクセス制御、Zero Trust の基本概念を確認  

* **環境整理**
  - サブスクリプションの見直しで学習リソースを最適化  
  - キャッシュフロー改善の第一歩を実行  

---

## 🎯 学び・気づき
* セキュリティ領域は「概念理解」が重要であり、現場経験と直結する  
* 小さくても日々アウトプットすると、進捗が客観的に見える  
* 学習リソースを絞ることで、集中力が高まりやすい  

---

## ✅ 今日できたこと
* [SC-900 学習ガイド（検索結果一覧）](https://learn.microsoft.com/ja-jp/training/browse/?terms=SC-900)
の全体像を把握
---

## ⏭ 明日やること
- [ ] 「セキュリティ、コンプライアンス、ID の概念の概要」モジュールを進める  
---



# ✅ SC-900 学習チェックリスト（主要4モジュール版）

> 目標：2025年10月中に SC-900 合格
> 学習時間の目安：平日 30〜60分 / 週末 2〜3時間
...
* \[対応中] [セキュリティ、コンプライアンス、ID の概念の概要](https://learn.microsoft.com/ja-jp/training/paths/describe-basic-concepts-of-cybersecurity/)
* [ ] [Microsoft Entra の概要](https://learn.microsoft.com/ja-jp/training/paths/describe-basic-concepts-of-entra/)
* [ ] [Microsoft Priva と Microsoft Purview の概要](https://learn.microsoft.com/ja-jp/training/paths/describe-basic-concepts-of-purview-priva/)
* [ ] [Microsoft セキュリティ ソリューションの概要](https://learn.microsoft.com/ja-jp/training/paths/describe-basic-concepts-of-security-solutions/)

---

## Week 0（準備）

* [x] Microsoft Learn アカウント登録
* [x] **Practice Assessment（模擬試験）** を1回実施（弱点確認）
* [x] 学習ノート/TIL用のMarkdownファイル準備

---

## Week 1：概念の理解（モジュール1）

* [X] **共有責任モデル**（Shared Responsibility Model）
* [X] **セキュリティ・コンプライアンス・IDの基本概念**
* [X] **ゼロトラストモデル（Zero Trust）**
* [X] **IAMの基礎**（認証 / 認可 / RBAC）
* [X] Week1 復習メモ（TILに整理）

---

## Week 2：Microsoft Entra（モジュール2）

* [ ] **Entra ID（旧Azure AD）の概要**
* [ ] **シングルサインオン（SSO）**
* [ ] **多要素認証（MFA）**
...
## Week 4：Microsoft Security Solutions（モジュール4）
