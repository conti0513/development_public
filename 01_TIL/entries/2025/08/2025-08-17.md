...
## ✅ 今日の取り組み概要
業務の棚卸しを行い、秋以降のPJT参画方針を再確認。また、TIL（Today I Learned）の記録運用についても方針を明文化。

---

## ✅ Summary of Today's Work

### 1. Reviewed Past Work Responsibilities
* Listed major tasks handled over the past year.
* Clarified responsibilities such as:

  * Assisting IT Managers (MGR)
  * Acting as a PMO (project coordination, scheduling)
  * Managing SaaS tools
  * Coordinating with low-voltage vendors
* Identified tasks that are high-load or overly dependent on individuals.

### 2. Defined Project Participation Policy (from Autumn onward)

* Prioritized joining projects that:

  * Have low management pressure
  * Avoid placing full responsibility on one subcontractor
  * Focus on PMO and security operations
* Targeted a shift to environments where workflows are already in place, allowing for better performance and recovery.

### 3. Established TIL Update Guidelines

* Maintain TIL in bullet-point format, updated daily or every other day.
* Use Markdown formatting for structure and clarity.
* Store in GitHub for tracking learning progress and use as documentation during interviews.

---

## 💡 Takeaways

* Regular work reviews clarify both strengths and limits.
* Continuing TIL updates helps build a consistent portfolio and evidence of growth.
* Defining a clear direction allows for better project alignment and sustainable output.
---
