...
* **業務棚卸し**
  * Identity & Access を中心に経験を棚卸し
  * IAM / RBAC / SSO / MFA / JIT / PAM を整理し、経験・規模感・規格との関連を明確化

* **セキュリティ用語の再整理**
  * 英語フルスペル＋略語＋日本語を統一
  * 「定義＋経験＋実務適用例＋規模感＋関連規格＋経験レベル」のフォーマットに調整

* **ドキュメント整理**
  * [security.md](../devops_notes/security/keywords.md) へ反映できる形でMarkdown化
  * GitHub公開を意識し、営業色を薄め客観的な書き方に統一

---

## 🎯 学び・気づき
  * 規模感（100〜500名／10万人超）や規格（NIST, ISO, CIS）を添えることで、内容に具体性と信頼性が増す
  * 「導入／運用／改善／監査」といったフェーズで区切ると、自分の経験を整理しやすくなる
  * 国際対応（グローバルユーザー管理）を明記すると、経験の幅を示すうえで有効

---

## 🚀 次のアクション

* **SaaSセキュリティ領域**の用語整理と経験の紐付けを進める
* security.md に追記して公開可能な形にブラッシュアップ
* TIL 継続更新で「セキュリティ実務の棚卸し」を完了させる
