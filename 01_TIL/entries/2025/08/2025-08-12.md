...
**概要（日本語）**
弱電関連のベンダー（NTT・人流カメラ・POS）との調整を行い、前任者が未着手だったバックログの整理と進捗管理を実施。特に新店舗ネットワークのヒアリング準備が今週の重要課題。

---

## 🛠️ Today's Work: Low-voltage vendor coordination and backlog structuring

### 🔹 Vendor coordination

* Handled scheduling and coordination with:

  * **NTT** (telecom lines)
  * **People-counting camera vendor**
  * **POS system vendor**
* Identified unclear responsibilities and clarified key contacts

### 🔹 Backlog cleanup

* Due to the previous manager’s sudden departure, there was **no documentation or backlog**
* Created tickets from scratch to ensure traceability and prevent omissions
* Structured ongoing issues for **team-wide visibility**

### 🔹 This week’s key issue

* Preparing for **network requirements hearing** for a new store
* Need to clarify layout, IP addressing, and required connectivity specs to avoid future delays
