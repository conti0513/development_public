...
- Practiced **modal verbs** and **conditional sentences** in English (1問1答 format).
- Understood the meaning and usage of:
  - Modal verbs like **must, might, may, shall, would**, etc.
  - Conditional types: **Zero**, **First**, **Second**, **Third**, and **Mixed**.
- Clarified key grammar terms like "**hypothetical**" and "**preference**" through Q&A.
- Explored the benefit of **audio learning** for better memorization and review.

---

## 🧠 New Concept: English Quiz Prompt Strategy

- Designed a custom prompt for one-question-at-a-time English grammar quizzes.
- Example:
  > “Ask me one question at a time about modal verbs. Wait for my answer before responding.”

- Realized this helps maintain focus and is effective for **ADHD-friendly learning**.

---

## 🔁 Next Steps

- Keep using the one-question quiz method for reviewing grammar points.
- Begin writing mini English scripts using modal verbs and conditional sentences.
- Try integrating **audio-based** response practice into the daily routine.
