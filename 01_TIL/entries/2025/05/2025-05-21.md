...
- Explored business structure  
  - Considered small-business **loan options** and **incorporation plan**  
  - Evaluated future scalability, risk separation, and funding strategy

- Completed eBay listing workflow  
  - Product photography, writing descriptions, choosing categories, preparing for shipping  
  - Gained insight into the full sales process and how to **systematize it for repeatability**

---

### 💬 Reflections

- Incorporation and financing are not goals — they are the **foundation for turning vision into reality**
- Listing may seem small, but **selling = delivering value**
- Each step is a practical move toward my **next village**
