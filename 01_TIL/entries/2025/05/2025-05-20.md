...
- Designed a compact **Cloud Run-based monitoring system**
  - Monitors ~20 websites and X posts
  - Triggers notifications to **LINE Notify**
  - Managed with **CSV (url, keyword, context)** for flexibility
  - GAS not used; scheduled via Cloud Scheduler
  - Low-cost design, mostly within free tier

---

## 🛡️ Security+ SY0-701 – Section 04.4

### 87 – Security Monitoring
- *Attacks never sleep* — continuous monitoring is essential
- Functions:
  - **Scanning**, **archiving**, and **alerting**
  - Systems like **SIEM**, log analyzers, and automation are core

### 88 – Security Tools
- Tools matched to specific security needs:
  - **Nmap** – network scanner
  - **Wireshark** – packet & protocol analysis
  - **SCAP** – automated vulnerability standards
  - **DLP** – protect against sensitive data loss
  - **SNMP** – monitor/manage network devices
  - **Forensics tools** – evidence handling and verification
...
- Security monitoring requires not just tools, but **structure**, **prioritization**, and **communication clarity**.
- The Cloud Run system design today reflects the same: lightweight, structured, and sustainable.
