# 📘 TIL - 2025/06/14-15 Weekend Summary

## 🧼 Cleaning & Photography

* Cleaned **6 vintage cameras**
* Took product photos of **6 units**
* Noticed significant improvement in photography skills — lighting and angles are getting better

## 📦 Sales

* Sold and shipped **1 camera via eBay**

## 🛠️ Repair & Curation

* Successfully restored a **Zorki rangefinder** — mechanical condition stabilized
* The attached lens was a **Jupiter-8 Red N** — high value, but the original seller didn't notice
* Acquired at a bargain price due to mislabeling; will consider similar **Barnack-style cameras** in future sourcing strategy
* This discovery shows the importance of checking attached lenses carefully — can greatly affect resale value

## 🪄 Insight

* Product photography is steadily improving and becoming a strong asset
* This workflow — **cleaning → photographing → listing → shipping** — is becoming smoother
* Will continue to refine this model and scale operations
---
