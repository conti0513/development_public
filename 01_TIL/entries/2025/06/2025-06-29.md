# 📘 TIL - 2025-06-27 to 29: Zorki Realization & Focus Shift

## 🧠 Key Insight

While working on the **Zorki body**, I realized something important:

- I deeply **respect the Zorki design** — it's beautiful and historically valuable.
- However, during repair, I found that **repeated manual charging and speed adjustments caused finger pain.**
  - ⭐️ The shutter needs to be cocked **hundreds of times** for fine-tuning.
  - It takes **a lot of time and physical strain**.

## 🎯 Decision

- For now, I will move Zorki into my **“respect-only” category**, not active repair.
- Instead, I’ll **focus on lenses**, where I have stronger skills and better workflow.

> ⭐️ Build from strengths first — then expand.

## ✅ Next Steps

- Continue cleaning, adjusting, and documenting vintage lenses.
- Consider coming back to Zorki in the future with better tools or methods.
- Save time and protect energy by narrowing focus.


# 📘 TIL - Language Depth Log: [Song/Quote/Word]
...
## 🧠 Double Meaning & Irony

- **Literal**: A person who pretends or hides their true identity.
- **Figurative**: 
  - A challenge to **fake authority / government / societal systems**.
  - An internal battle: *"Am I also pretending?"* → self-irony.
  - Historical undertone: “Pretender to the throne” = illegitimate power.
...
- 誰に向けて？自分か？体制か？  
- “Surrender” は物理的降伏だけでなく、**心を委ねること**でもある。

## 🔗 Social / Political Layer

- Possibly a critique of:
  - Governmental control
  - Compliance culture
  - The music industry or media narrative itself

## 🧠 Personal Reflection (optional)

- Reminds me of situations where I also “pretend” or hide parts of myself.  
- Sometimes rebellion is quiet — and sometimes it screams in power chords.

## 📝 Keywords

`irony`, `self-awareness`, `system critique`, `identity`, `layered English`, `punk attitude`


## 🧠 Reflection (TIL-style)

I still struggle with abstract English vocabulary,  
and I feel frustrated that I can’t fully express the emotion this song gave me.  
But even so—**this was a powerful and beautiful lesson for me.**

I learned:

- The **depth of English** — how simple words can carry complex, layered meaning  
- The **beauty of lyrics** — when voice, words, and sound create a unified emotional world  
- The way great singers build **internal landscapes** through minimal language, strong delivery, and honesty

> Even without perfect words, I *felt* it — and that’s what matters.

That was an awesome way to put it.

Thank you. I was deeply moved. I really felt something powerful through the lyrics and sound.

It touched me in a way I didn’t expect. Simple words, but such deep emotion.
---
