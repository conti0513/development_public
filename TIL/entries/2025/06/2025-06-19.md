...
## 📘 TIL - No.3: Preventable Failures in Infrastructure Ops

### ✅ Key Incidents Reviewed

* Major service outage caused by misunderstanding VLAN overwrite behavior.
* Midnight deployment failure due to fatigue and paper-based procedure gaps.
* Internal data loss due to vague Slack-based request and lack of structured approval.

### 🧠 What I Learned

1. **Ambiguity kills** — Phrases like *“just delete it nicely”* often lead to irreversible outcomes.
2. **Trust ≠ process** — Reputations cannot replace proper checks.
3. **Structured communication matters** — Slack is not a substitute for documented procedures.
4. **Design mismatches matter** — Home-grade infra reused for enterprise needs strict validation.
5. **Tech ≠ ops** — System-level “recoverable” doesn't mean “business-safe.”

### 🔄 ADHD-Aware Practice Tips

* Always **write before action** — define what, who, and rollback plans.
* **Never act on oral or Slack-only requests** — move to structured notes or Notion.
* Use **checklists** even for “simple” tasks.
* **Pause** when unwell — no irreversible action in low condition.
* Value the **incidents that *didn’t* happen** due to solid structure.
