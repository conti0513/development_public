...
### 📘 TIL - Wi-Fi Assessment and Documentation

#### ✅ What I Did

* Assisted in reviewing and planning Wi-Fi configuration in a retail setting.
* Investigated potential interference between existing and planned networks.
* Drafted an initial improvement plan to enhance connectivity stability.
* Updated related documentation to reflect current and future network states.

#### 💡 Key Learnings

* Real-world Wi-Fi performance is often more situational than theoretical.
* Balancing technical optimization with field operability is essential.
* Environments with frequent layout or usage changes benefit from periodic design reviews.
...
## ✅ What I Did Today for eBay

* Ran my **first Markdown sale (10% OFF)** on eBay store
  → Scheduled for 24 hours, aligned with US golden hours (PDT 16:00–)

* Selected **5 high-watch-count items** for the sale
  → Focused on driving overall traffic; individual "Send Offer" will be tested later (for A/B comparison)

* Applied **Promoted Listings** to select items
  → Initial phase based on AI-suggested ad rates

## 🎯 What I Learned

* Markdown is a **store-subscriber-only promotion tool** and can help boost visibility
* "Send Offer" is useful for converting watchers, but it’s better to **time it separately** from Markdown for clearer performance measurement
* Promoted Listings **take time to show results**, so it’s best to start cautiously and monitor ROI

## 🧠 Insights

* Use **Markdown and Send Offer separately and strategically**
* With the store subscription plan now active, **weekly campaign cycles and iterations** will be necessary
* Early stage flow: **broaden exposure → reward engaged viewers**
