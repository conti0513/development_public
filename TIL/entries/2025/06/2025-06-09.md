...
* **Inspection and maintenance of cameras #6, #8, and #9**

  * Verified shutter operation, cleaned exterior, and completed basic maintenance.
* **Product photography for 5 items**

  * Used a compact setup to take listing-ready photos.
  * Focused on lighting and background for eBay presentation quality.
* **eBay listings for 5 items**

  * Created product titles, condition grading, and descriptions.
  * Uploaded photos and finalized pricing and listing.

### 🗒️ Notes

* Doing maintenance and photography back-to-back improves efficiency but drains focus quickly.
* Reusing past templates for listing descriptions speeds up the process.
* Each item took approximately 30 minutes from prep to listing.
