...
* Created a **Markdown sale event (10% OFF)** on eBay
  → Set from **June 16 to June 22, 2025**, covering eligible items
  → Included “keep items in sale” and “block price increase” options

* **Listed 2 new items** with polished descriptions and detailed condition notes

  1. **Yashicaflex TLR 80mm f/3.5**
     → Fully working, minor haze, vintage leather case + yellow filter included
  2. **Minolta XD Camera Set (35mm, 35–70mm, 100–500mm)**
     → For repair (prism deterioration), sold as-is with full transparency

* Improved existing mid-range listings with clearer condition grading and updated pricing strategy

* Confirmed total active listings to strategize toward a **\$500 weekly sales target**

## 🧠 Key Takeaway

Sales don’t happen passively — they’re *built* through curation, repair, storytelling, and trust-building. Today was another step in shaping that system.
