...
TIL - Week Summary (Mon–Wed)

- Repaired 3 camera sets (lens cleaning, shutter check, minor adjustments)
- Uploaded repair and product photos to Google Drive
- Recorded repair and inventory notes in tracking sheet
- Sourced 1 new item for resale

→ Repair workflow becoming smoother; logging backlog noted due to hands-on tasks.
→ Need to automate/simplify part of the repair-photo-log pipeline.
