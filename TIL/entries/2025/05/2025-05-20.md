...
* Goals: Monitor \~20 websites for updates, X posts, keywords like “ひき肉 予約”
* Notify via **LINE Notify** without using GAS
* URLs and keywords stored in **CSV** for scalability
