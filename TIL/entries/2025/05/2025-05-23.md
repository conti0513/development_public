...
## ✅ Theme: Business Infrastructure Setup at HQ

### 🧠 Engineer’s Perspective: Infrastructure & Business Stack Design

#### 1. 📡 Wi-Fi/Network Survey & Design (HQ)

* Investigated local Wi-Fi coverage and performance in head office areas
* Designed basic network layout considering employee density and traffic segmentation
* Drafted a lightweight architecture suitable for internal HQ use
* Considered VLAN separation for security and scalability

#### 2. 📦 eBay Business Operations

* Listed multiple products across categories with optimized titles and descriptions
* Analyzed competitor listings and historical prices for pricing strategy
* Ran sourcing idea sessions (仕入れ壁打ち) for future inventory planning
* Created a lightweight but repeatable listing workflow to reduce friction

#### 3. 🗱️ Business Operations Setup (Structural View)

* Treated the above activities not as "tasks" but as **infrastructure building blocks**
* Balanced system design (network) with business flow design (eBay)
* Used this context as a sandbox to prototype lean business operations

---

### 💬 Reflections

* Building a business is also engineering.
* By viewing tasks as components, the workload becomes architecture.
* Even in the mud, structure can be found—and improved.

---

### 🏷 Tags

`#TIL` `#eBay` `#network` `#infra_design` `#business_stack` `#hq`
