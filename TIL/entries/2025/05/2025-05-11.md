...
🔐 **Security+ Section 03.3 – Data Types, States, and Protection**
Studied how data is classified, how it moves, and how to protect it—through the lens of **lifecycle-aware architecture**.
...
* このセクションは、**「データ保護＝暗号化」だけではない**という意識改革をもたらした。
* データ分類・状態・防御策を**1つのライフサイクル設計として捉える視点**は、今後のSlack通知や監視設計にも応用可能。
* TILの積み上げによって、実装・構成・監査を一貫して設計できる基盤が見え始めている。

---

## 🧩 Application Ideas

* Draft `data_lifecycle_map.md` to visualize state–control mapping
...
* Start **Section 03.4 – Resilience & Recovery**
* Add glossary terms from today’s lectures to `glossary.md`
