...
### 🧾 Asset Management & Audit Prep

- Updated the IT asset management ledger for audit purposes  
- Created a centralized master list to align formats across departments (finance, systems, etc.)  
- Adjusted sheet structures to improve clarity and consistency  
- Left space for future automation (serial validation, input tracking, and reconciliation)

> Although the work was mostly manual and repetitive, I set up the groundwork for automation.  
> Quiet progress, but essential for making future iterations faster and cleaner.
